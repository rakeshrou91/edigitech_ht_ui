         ...
         <Grid>
           <Card className="contactussection" style={{boxShadow:'none'}}>
             ...
             <form >
                ...
                <Input className="input" placeholder="Mobile No"  required/><br/>
                <Input className="input" placeholder="Email Id"  required/><br/>
               
                <Input className="textfeild" placeholder="Message" multiline rows={2} rowsMax={4}/><br/>
         ...
         <Grid>
           <div className="row1">
             ...
             <Card className="addresssection" style={{borderRadius:'26px',boxShadow:' 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
                 <Avatar className="avatar1"  src={process.env.PUBLIC_URL + "/con-1.png"}  style={{height:120,width:100}}/>
                 
                 <span>Our Address</span>
                 <p>971-949 8th Ave<br/> New York, NY</p>
             </Card>
           </div>
           <div className="contcolumn">  
           <Card  className="addresssection" style={{borderRadius:'26px',boxShadow:' 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
                <Avatar className="contavatar" src={process.env.PUBLIC_URL + "/con-2.png"}  style={{height:120,width:120}}/>
       ...
       <Paper style={{boxShadow:'none'}}>
         <Grid>
           <Card className="textsection" style={{boxShadow:'none'}}>
                ...
                <p>We are committed to being the best partner.eHealthFlex believes in being your trusted partner and earning that trust <br/> through confidence and performance in service and support.</p>
           </Card>
           <Card className="brands" style={{boxShadow:'none'}}>
             <ul >
              ...
              <ul >
                   <li style={{borderBottom:"none"}}><Image src={process.env.PUBLIC_URL + "/brands-4.png"} /></li>
                   <li style={{borderBottom:"none"}}><Image src={process.env.PUBLIC_URL + "/brands-3.png"} /></li>
