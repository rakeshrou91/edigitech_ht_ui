...
<Card className="standardservices">
  ...
  <Card className="standardoverviewcard">
     <h4>highlights</h4>
     <ul>
       <li><i class="fas fa-check"></i>  A full-time language interpreter will be provided</li>
       <li><i class="fas fa-check"></i>  Priority for the treatment will be given to premium members</li>
       <li><i class="fas fa-check"></i>  Full-time Valet support</li>
       <li><i class="fas fa-check"></i>  24x7 customer support services to resolve the issues</li>
       <li><i class="fas fa-check"></i>  Currency, SIM, Internet & Banking Assistant</li>
       <li><i class="fas fa-check"></i>  Dedicated personal assistance</li>
       <li><i class="fas fa-check"></i>  The package will also include recreational activities which can be customized as per the client requirement</li>
