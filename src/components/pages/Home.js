...
<div class="column1">
  ...
  const getdiagnosedContent=<div>
     <Card className="card" style={cardstyle}>
          ...
          <TextField style={{width:'436px',marginTop:'10px',marginRight:'20px'}} id="outlined-basic" label="Email Address" variant="outlined" />
          <TextField style={{width:'436px',marginTop:'10px'}} id="outlined-basic" label="Contact Number" variant="outlined" /><br/>
          <TextField style={{width:'896px',marginTop:'10px'}}id="outlined-basic" label="Address" variant="outlined" />
          <TextField style={{width:'400px',marginTop:'10px',marginRight:'10px'}} id="outlined-basic" label="Country" variant="outlined" />
          <TextField style={{width:'300px',marginTop:'10px',marginRight:'10px'}} id="outlined-basic" label="State" variant="outlined" />
          <TextField style={{width:'160px',marginTop:'10px',marginRight:'10px'}} id="outlined-basic" label="Pin Code" variant="outlined" /><br/>
          <input type="file" className="custom-file-input" id="customFile" name="file[]" multiple="multiple"/>
        ...
        <Grid>
          <Card className="reactoutsection" style={{cardstyle,boxShadow:'none'}}>
              <div class="rt1-section-title">
                       ...
                       <button onClick={()=>{setGetdiagnosed(!getdiagnosed)}} style={{backgroundColor:'#5BD1D7',borderColor:'#5BD1D7'}} class="button111">Get Diagnosed </button> <space/><space/><br/>
