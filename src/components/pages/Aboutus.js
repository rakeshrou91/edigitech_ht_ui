  ...
  return (
    ...
    <Paper className="paper" style={{boxShadow:'none'}}>
      <Grid>
       ...
       group is here to hold your hand. We work with the best Doctors and Hospitals in India and the world. We guarantee you to 
       give you the budget fit and the quality treatment alongside the fundamental data about the treatment and the 
       connected plans. We are overall related with all medical services divisions and these medical care suppliers are for the
       most part assessed dependent on their worldwide certificates and affiliations. Cautiously and distinctly, we examine
       and confirm the experience of each specialist to guarantee the most elevated potential paces of progress, interfacing
       individuals through the most recent innovation and the computerized stages Thus, making an ideal framework. We are 
       here to mastermind the best internet-based specialists for your arrangements across India, remembering every one of 
       your necessities. We will try to benefit you of the administrations through the most recent advances utilized by our 
